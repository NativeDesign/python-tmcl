...
class Test__rotate_right (object):
	...
	def test__velocity_must_be_an_int (self):
		...
		with raises(AssertionError):
			motor.rotate_right("not an integer")
	...
	def test__velocity_must_be_within_bounds (self):
		...
		with raises(AssertionError):
			motor.rotate_right(-123)

		with raises(AssertionError):
			motor.rotate_right(101)

		motor.rotate_right(50)
